    ...
    <section id="horarios" className="py-24 md:py-32 border-t border-border">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {days.map((item, i) => (
            <AnimateIn key={item.day} delay={i * 200} direction="up">
              <div className="group relative overflow-hidden rounded-lg border border-border bg-card p-8 md:p-10 hover:border-primary/40 transition-colors h-full">
                <div className="absolute top-0 left-0 h-1 w-full bg-primary origin-left transition-transform duration-500 group-hover:scale-x-100 scale-x-75" />
